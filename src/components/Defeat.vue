<template>
	<div class="modal_content">
		...
		<div class="modal_content_controlls">
			<router-link class="modal_content_controlls_item" to="/levels" tag="button">
			...
			<button class="modal_content_controlls_item" @click="$emit('refresh')">
